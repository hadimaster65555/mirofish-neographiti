...
- Entities mutually influence each other, repost, comment, and respond
- We need to simulate the reactions of various parties and information propagation paths in public opinion events

Therefore, **entities must be real, existing subjects in reality that can speak and interact on social media**:
...
- Various people will appear in the text, such as "elementary school teachers", "passersby", "certain netizens"
- If there is no dedicated type to match, they should be classified into `Person`
...
- Person: Any individual person (use when none of the specific types above apply)

**Organization types (specific)**:
- University: Universities and colleges
- Company: Companies and enterprises
